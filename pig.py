#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""IS_211 Week 8, Assignment 1, Pig Game Revised."""
...
def nextgame():
    ...
    if new.lower() == "read":
        ...
        print
    if new.lower() == "start":
        player_1 = raw_input("Player 1: Are you Human or Computer? ").lower()
        player_2 = raw_input("Player 2: Are you Human or Computer? ").lower()
        die = dice()
        if player_1 == "human":
            player_1 = human()
    ...
    if new.lower() == "timed":
        ...
        print 'You must enter "Start" or "Timed" to begin. '
        nextgame()
